import{a as e,d as t,i as n,l as r,n as i,o as a,r as o,s,t as c,u as l}from"./index-GYoCanKI.js";var u=t(l(),1),d={Wrapper:s.div`
        position: fixed;
        inset: 0;
        z-index: 2000;
    ...
    `},_=({appName:e,shareUrl:t})=>{let[n,r]=(0,u.useState)(!1),i=(0,u.useRef)(null);(0,u.useEffect)(()=>()=>{window.clearTimeout(i.current)},[]);let a=()=>{r(!0),window.clearTimeout(i.current),i.current=window.setTimeout(()=>{r(!1)},2e3)},s=async()=>{await navigator.clipboard.writeText(t),a()};return(0,f.jsx)(g.Wrapper,{type:`button`,onClick:async()=>{if(t)try{if(navigator.share){await navigator.share({title:e,text:`Download ${e} for Android.`,url:t});return}await s()}catch(e){if(e.name===`AbortError`)return;try{await s()}catch{r(!1)}}},disabled:!t,"aria-label":`Share ${e}`,title:n?`Link copied`:`Share app`,children:n?(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(c,{"aria-hidden":`true`}),(0,f.jsx)(`span`,{children:`Copied`})]}):(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(o,{"aria-hidden":`true`}),(0,f.jsx)(`span`,{children:`Share`})]})})},v=[{id:`essential-everyday-apps`,category:`Essential Everyday Apps`,apps:[{id:`unit-converter`,name:`Unit Converter`,description:`Length, weight, temperature, area, volume, speed aur data conversion.`},{id:`smart-calculator`,name:`Smart Calculator`,description:`Basic, scientific, percentage aur calculation history.`},{id:`percentage-calculator`,name:`Percentage Calculator`,description:`Percentage, increase, decrease, difference aur value calculation.`},{id:`age-calculator`,name:`Age Calculator`,description:`Exact age, next birthday aur total days/months calculation.`},{id:`date-calculator`,name:`Date Calculator`,description:`Do dates ke beech difference aur kisi date mein days add/subtract karna.`},{id:`discount-calculator`,name:`Discount Calculator`,description:`Discount ke baad final price aur total savings.`},{id:`tip-calculator`,name:`Tip Calculator`,description:`Tip calculate karke bill ko multiple people mein split karna.`},{id:`gst-calculator`,name:`GST Calculator`,description:`GST add/remove aur tax breakup calculate karna.`},{id:`emi-calculator`,name:`EMI Calculator`,description:`Loan EMI, total interest aur total payment calculation.`},{id:`fuel-cost-calculator`,name:`Fuel Cost Calculator`,description:`Distance, mileage aur fuel price se trip cost calculate karna.`},{id:`currency-converter`,name:`Currency Converter`,description:`Cached exchange rates ke saath currency conversion.`},{id:`time-zone-converter`,name:`Time Zone Converter`,description:`Different countries aur cities ka time compare karna.`}]},{id:`productivity-apps`,category:`Productivity Apps`,apps:[{id:`notes-app`,name:`Notes App`,description:`Offline notes create, edit, search, pin aur archive karna.`},{id:`todo-list`,name:`To-Do List`,description:`Daily tasks create, complete aur manage karna.`},{id:`daily-planner`,name:`Daily Planner`,description:`Din ke tasks aur schedule ko simple timeline mein manage karna.`},{id:`shopping-list`,name:`Shopping List`,description:`Grocery items, quantity, checked items aur reusable lists.`},{id:`reminder-app`,name:`Reminder App`,description:`Local notifications ke saath one-time aur repeating reminders.`},{id:`stopwatch-and-timer`,name:`Stopwatch and Timer`,description:`Multiple countdown timers, stopwatches, lap timing aur saved presets.`}]},{id:`text-and-communication-tools`,category:`Text and Communication Tools`,apps:[{id:`text-toolkit`,name:`Text Toolkit`,description:`Text case conversion, word count, cleanup, sorting aur duplicate removal.`},{id:`password-generator`,name:`Password Generator`,description:`Strong passwords aur passphrases generate, customize aur securely copy karna.`},{id:`qr-barcode-toolkit`,name:`QR and Barcode Toolkit`,description:`Text, links, contacts aur Wi-Fi ke QR codes generate karna, barcode scan karna, save, copy aur share karna.`},{id:`voice-notes-transcription`,name:`Voice Notes and Transcription`,description:`Voice recording, speech-to-text notes, playback, editing aur search.`},{id:`text-to-speech-reader`,name:`Text to Speech Reader`,description:`Entered ya pasted text ko device voice se read, pause aur resume karna.`},{id:`multilingual-voice-translator`,name:`Multilingual Voice Translator`,description:`Voice input, text translation, language swap, speech output aur history.`},{id:`offline-mesh-chat`,name:`Offline Mesh Chat`,description:`Nearby Android devices ke beech Bluetooth-based offline private messaging.`}]},{id:`files-images-and-documents`,category:`Files, Images and Documents`,apps:[{id:`image-toolkit`,name:`Image Toolkit`,description:`Images compress, resize, crop, rotate aur JPG, PNG, WebP mein convert karna.`},{id:`document-scanner`,name:`Document Scanner`,description:`Camera se documents capture, crop, enhance aur PDF mein export karna.`},{id:`pdf-toolkit`,name:`PDF Toolkit`,description:`Images to PDF, PDF merge, split, reorder, rotate aur page extraction.`},{id:`private-file-vault`,name:`Private File Vault`,description:`PIN-protected offline vault mein private images aur documents secure rakhna.`},{id:`file-integrity-checker`,name:`File Integrity Checker`,description:`SHA-256 checksums generate, copy, compare aur files verify karna.`},{id:`photo-metadata-cleaner`,name:`Photo Metadata Cleaner`,description:`Photos se location, device aur other metadata inspect aur remove karna.`},{id:`storage-analyzer`,name:`Storage Analyzer`,description:`Files ko size aur type ke hisaab se analyze karke large files identify karna.`}]},{id:`device-and-sensor-utilities`,category:`Device and Sensor Utilities`,apps:[{id:`step-counter`,name:`Step Counter`,description:`Device sensor se daily steps, estimated distance, goals aur history track karna.`},{id:`compass-coordinates`,name:`Compass and Coordinates`,description:`Direction, heading, latitude, longitude, accuracy aur location sharing.`},{id:`sound-level-meter`,name:`Sound Level Meter`,description:`Microphone input se approximate surrounding sound level monitor karna.`},{id:`device-sensor-monitor`,name:`Device Sensor Monitor`,description:`Accelerometer, gyroscope, magnetometer aur available sensors ka live data.`},{id:`network-information-tool`,name:`Network Information Tool`,description:`Current connection, local IP, network type aur basic connectivity details.`}]},{id:`sharing-and-offline-tools`,category:`Sharing and Offline Tools`,apps:[{id:`local-file-share`,name:`Local File Share`,description:`Same Wi-Fi network par devices ke beech files locally transfer karna.`},{id:`offline-clipboard`,name:`Offline Clipboard`,description:`Important copied text, links aur reusable snippets locally organize karna.`}]}],y=a`
    from {
