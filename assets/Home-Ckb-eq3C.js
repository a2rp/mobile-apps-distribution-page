import{a as e,c as t,i as n,n as r,r as i,s as a,t as o}from"./index-ICQVDPCh.js";var s=t(a(),1),c={Wrapper:e.div`
        width: min(100%, 460px);
        min-height: 50px;
        display: flex;
        align-items: center;
...
`,f={Wrapper:e.div`
    ...
    `,MessageText:e.p`
        ...
        font-size: 14px;
        line-height: 1.7;
    `},p=()=>{let[e,t]=(0,s.useState)([]),[n,r]=(0,s.useState)([]),[i,a]=(0,s.useState)(``),[o,c]=(0,s.useState)(``),[d,p]=(0,s.useState)(!0),[m,h]=(0,s.useState)(``);(0,s.useEffect)(()=>{let e=new AbortController;return(async()=>{try{p(!0),h(``);let n=await fetch(`/mobile-apps-distribution-page/data/apps.json`,{signal:e.signal});if(!n.ok)throw Error(`Unable to load mobile apps.`);let i=await n.json(),o=Array.isArray(i.categories)?i.categories:[],s=Array.isArray(i.apps)?i.apps:[];t(o),r(s),o.length>0&&a(o[0].id)}catch(e){e.name!==`AbortError`&&h(e.message)}finally{e.signal.aborted||p(!1)}})(),()=>{e.abort()}},[]);let g=(0,s.useMemo)(()=>{let e=o.trim().toLowerCase();return e?n.filter(t=>[t.name,t.description,t.packageName,t.platform,t.version].filter(Boolean).join(` `).toLowerCase().includes(e)):n},[n,o]),_=(0,s.useMemo)(()=>g.reduce((e,t)=>(t.category&&(e[t.category]=(e[t.category]||0)+1),e),{}),[g]),v=(0,s.useMemo)(()=>g.filter(e=>e.category===i),[i,g]),y=e.find(e=>e.id===i);return(0,l.jsxs)(f.Wrapper,{children:[(0,l.jsx)(f.Hero,{children:(0,l.jsxs)(f.Container,{children:[(0,l.jsx)(f.Eyebrow,{children:`a2rp Mobile Apps`}),(0,l.jsx)(f.Title,{children:`Mobile apps built for everyday use`}),(0,l.jsx)(f.Description,{children:`Explore free applications, premium tools and experimental mobile projects created by Ashish Ranjan.`})]})}),(0,l.jsx)(f.AppsSection,{children:(0,l.jsxs)(f.Container,{children:[d&&(0,l.jsx)(f.LoadingState,{children:(0,l.jsx)(f.Spinner,{})}),!d&&m&&(0,l.jsxs)(f.MessageState,{children:[(0,l.jsx)(f.MessageTitle,{children:`Apps could not be loaded`}),(0,l.jsx)(f.MessageText,{children:m})]}),!d&&!m&&(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)(`div`,{className:`searchArea`,children:(0,l.jsx)(u,{value:o,onChange:c})}),(0,l.jsx)(f.Tabs,{role:`tablist`,"aria-label":`Mobile app categories`,children:e.map(e=>(0,l.jsxs)(f.TabButton,{type:`button`,role:`tab`,"aria-selected":i===e.id,$active:i===e.id,onClick:()=>a(e.id),children:[(0,l.jsx)(`span`,{children:e.label}),(0,l.jsx)(`span`,{className:`tabCount`,children:_[e.id]||0})]},e.id))}),y&&(0,l.jsx)(f.CategoryDescription,{children:y.description}),v.length>0?(0,l.jsx)(f.Grid,{children:v.map(e=>{let t=e.icon?`/mobile-apps-distribution-page/${e.icon}`:``;return(0,l.jsxs)(f.AppCard,{children:[(0,l.jsxs)(`div`,{className:`cardTop`,children:[(0,l.jsx)(f.AppIcon,{children:t?(0,l.jsx)(`img`,{src:t,alt:`${e.name} icon`}):`AR`}),e.status&&(0,l.jsx)(f.Status,{children:e.status})]}),(0,l.jsxs)(f.AppContent,{children:[(0,l.jsx)(f.AppName,{children:e.name}),(0,l.jsx)(f.AppDescription,{children:e.description}),(0,l.jsxs)(`div`,{className:`appMeta`,children:[e.version&&(0,l.jsxs)(`span`,{children:[`Version`,` `,e.version]}),e.platform&&(0,l.jsx)(`span`,{children:e.platform})]}),(0,l.jsxs)(`div`,{className:`appActions`,children:[e.apkUrl&&(0,l.jsx)(`a`,{className:`downloadButton`,href:e.apkUrl,target:`_blank`,rel:`noreferrer`,download:!0,children:`Download APK`}),e.releaseUrl&&(0,l.jsx)(`a`,{className:`releaseButton`,href:e.releaseUrl,target:`_blank`,rel:`noreferrer`,children:`Release Notes`})]})]})]},e.id)})}):(0,l.jsxs)(f.MessageState,{children:[(0,l.jsx)(f.MessageTitle,{children:o?`No matching apps found`:`No apps available yet`}),(0,l.jsx)(f.MessageText,{children:o?`Try searching with a different app name or keyword.`:`Applications in this category will be added soon.`})]})]})]})})]})};export{p as default};